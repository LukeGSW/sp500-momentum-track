"""
Analitiche descrittive sulla mappa: transizioni, permanenza, snapshot, traiettorie.
...
def build_snapshot(
    ...
    *,
    ...
    """Fotografia della mappa a una data: una riga per titolo eleggibile."""
...
def build_trails(
    ...
    *,
    ...
    """Formato lungo (date, ticker, F, V) per disegnare le traiettorie.

    Sottocampionato ogni `step_days` sedute: una traiettoria di 13 settimane ha ~65

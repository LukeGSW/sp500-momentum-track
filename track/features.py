"""
Il segnale: RS Score, RS Slope, fasce.
...
def compute_force(
    ...
    """RS Score: la coordinata verticale sulla mappa.
...
def compute_velocity(
    ...
    """RS Slope: la pendenza della traiettoria, ri-standardizzata trasversalmente."""

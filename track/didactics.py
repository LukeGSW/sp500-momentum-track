...
Uso nelle pagine:  didactics.render("mappa")
"""
...
_add("mappa", Block(
    title="Monitor di Forza Relativa",
    cosa=(
        "Ogni pallino e' un titolo dell'S&P 500. La posizione **verticale** e' la "
        "**RS Score**: quanto quel titolo sta andando meglio o peggio "
        ...
        "appartiene: sono 11 colonne settoriali parallele, non un secondo asse numerico."
    ),
    lettura=(
        ...
        "**La traiettoria e' il momentum.** La coda dietro ogni pallino mostra dove "
        "si trovava il titolo nelle settimane precedenti. Traiettoria che punta "
        "verso l'alto = forza relativa in aumento, verso il basso = in calo. Con un "
        "asse verticale unico il momentum non ha bisogno di un asse proprio: **e' "
        "la pendenza**.",
        "**Il colore** codifica il segno della RS Slope (la pendenza misurata "
        ...
        "sta Q1 Laggard (il 20% piu' debole), sopra Q5 Leader (il 20% piu' "
        "forte). Essendo quintili, ogni banda contiene sempre lo stesso numero "
        "di titoli: e' un ordinamento, non una soglia assoluta.",
        "**Titoli concentrati in una colonna settoriale** significa rotazione settoriale in "
        "corso. Se Q5 Leader e' per meta' Information Technology, il 'momentum' "
        "che stai guardando e' in buona parte una scommessa su un settore.",
    ),
    attenzione=(
        "F **non e' un prezzo e non e' un rendimento**. Un titolo in Q5 Leader "
        ...
        "sono gia' stati esclusi: quello che vedi in fondo alla mappa e' "
...
_add("velocita", Block(
    ...
    cosa=(
        ...
        "risalendo o scendendo lungo la mappa."
    ),
    lettura=(
        "**RS Slope > 0**: il titolo sta guadagnando forza relativa. **RS Slope < 0**: la sta "
        "perdendo.",
        ...
        "**Q5 Leader con V negativo**: un leader che sta ritracciando. E' la "
        "definizione piu' pura di 'comprare la debolezza momentanea di un titolo "
        "forte', e non coincide con Q1 Laggard.",
    ),
    attenzione=(
    ...
    formula="V = pendenza OLS dell'RS Score sulle ultime 63 sedute, ri-standardizzata trasversalmente.",
))
...
_add("snapshot_table", Block(
    ...
    cosa=(
        ...
        "mappa alla data piu' recente disponibile."
    ),
    lettura=(
        ...
        "mese fa: se differiscono, il titolo si sta muovendo lungo la mappa.",
    ...
    attenzione=(
        ...
        "nella mappa ma sono marcati come non tradabili.",
    ),
))
...
_add("band_distribution", Block(
    ...
    lettura=(
        ...
        "Confronta Q5 Leader e Q1 Laggard: se i settori sono speculari (es. "
...
_add("transition_matrix", Block(
    ...
    lettura=(
        "**Leggi per riga.** Ogni riga somma a 100%. La cella (Q5 Leader, Q5 "
        "Leader) e' la probabilita' che un leader resti leader il mese prossimo.",
        ...
        "**Le celle agli angoli** (Q5 Leader -> Q1 Laggard e viceversa) sono "
        ...
        "backtest: se la persistenza in Q5 Leader e' alta e quella in Q1 "
        "Laggard bassa, il momentum e' un fenomeno reale in questo campione.",
    ),
    attenzione=(
        "Persistenza **non significa profitto**. Un titolo puo' restare in Q5 "
        "Leader per sei mesi generando un rendimento mediocre: il quintile misura "
...
_add("dwell_time", Block(
    ...
    lettura=(
        ...
        "titoli restano in Q5 Leader mediamente 5 mesi, un holding di 3 mesi "
...
_add("equity_curves", Block(
    ...
    lettura=(
        "**Q5 Leader** = i 30 titoli piu' forti. **Q1 Laggard** = i 30 piu' "
        "deboli fra quelli comunque sopra la media a 200 sedute. Sono le due "
        "risposte candidate alla domanda dello studio.",
        "**Q5 in ritracciamento** = leader con RS Slope negativo. E' la "
        "terza risposta, quella che molti trader intendono davvero con "
        "'comprare la debolezza'.",
        "**Q3 In linea** e' il quintile centrale: serve da controllo. Se Q5 Leader e "
        "Q1 Laggard battono entrambi Q3 In linea, il segnale sta premiando gli "
...
_add("metrics_table", Block(
    ...
    lettura=(
        ...
        "**Guarda Sharpe e vol prima del CAGR.** Q1 Laggard contiene titoli "
...
_add("null_distribution", Block(
    ...
    lettura=(
        ...
        "Se la linea di Q5 Leader cade **dentro** il corpo dell'istogramma, la "
...
_add("subperiods", Block(
    ...
    lettura=(
        ...
        "distrutto capitale. Se Q1 Laggard vince nel campione completo ma "
...
_add("drawdown", Block(
    ...
    lettura=(
        ...
        "Confronta i drawdown dei panieri **nello stesso momento**: se Q5 "
        "Leader e Q1 Laggard crollano insieme, non stai diversificando nulla, "
...
_add("cost_breakeven", Block(
    ...
    lettura=(
        ...
        "Q1 Laggard ruota il 50% e Q5 Leader il 32%, alzando i costi il "
...
_add("delisting_stress", Block(
    ...
    lettura=(
        ...
        "spariscono sono sistematicamente concentrati nel paniere Q1 Laggard: "
...
_add("coverage", Block(
    ...
    lettura=(
        ...
        "coverage e' peggiore in Q1 Laggard — e lo sara' — il bias spinge il "
...
_add("price_cap_exclusions", Block(
    ...
    lettura=(
        ...
        "**Direzione del bias: contro il paniere Q5 Leader.** E' l'opposto del "
...
_add("turnover", Block(
    ...
    lettura=(
        ...
        "Confronta il turnover di Q5 Leader e Q1 Laggard: se sono molto "
...
_add("filter_decomposition", Block(
    ...
    lettura=(
        "**La riga che conta e' lo Spread Q5 − Q1.** Se resta grande anche "
        ...
        "**Confronta Q5 Leader con filtro attivo e spento.** La differenza e' "
        "il contributo del filtro a quel paniere. Stessa cosa per Q1 Laggard: "
    ...
    attenzione=(
        ...
        "disfatta, non in ritardo relativo. Il paniere Q1 Laggard diventa un "
        "portafoglio di titoli strutturalmente compromessi, e il confronto con "
        "Q5 Leader misura qualcosa di piu' brutale.",

...
TOP, BOT, UNI = "Testa Corsa", "Fondo Griglia", "Universo eleggibile (senza costi)"
...
def test_persistenza_entra_fra_le_evidenze():
    ...
    pers = pd.DataFrame(
        ...
        index=["Fondo Griglia", "Rimonta", "Gruppo", "Scia", "Testa Corsa"],
        columns=["Fondo Griglia", "Rimonta", "Gruppo", "Scia", "Testa Corsa"],
    )

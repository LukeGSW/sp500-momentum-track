...
def test_fascia_alta_batte_fascia_bassa_con_drift_persistente():
    ...
    top = bt.run_strategy(panel, bt.selector_band(5, cfg.n_names, True), cfg, name="Q5 Leader")
    bottom = bt.run_strategy(panel, bt.selector_band(1, cfg.n_names, False), cfg, name="Q1 Laggard")

...
st.title("📈 Monitor di Forza Relativa — Metodologia")
...
**La seconda e' di lettura.** Su un asse verticale unico il momentum non ha bisogno di
...
### RS Score — la posizione sulla mappa
...
### RS Slope — la velocita' lungo la mappa
...
Combinando quintile e segno dell'RS Slope si ottengono **dieci stati** invece di
...
- **Lo spread Q5 − Q1 non e' implementabile**: i panieri
